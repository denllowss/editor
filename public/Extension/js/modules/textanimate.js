...
window.TextAnimateModule = (function () {
    ...
    function _buildScript(presetKey, inDur, outDur, basedOnVal) {
        ...
        return [
            ...
            '        if(_animators.property(_i).name.indexOf("DenjiMotion - ")===0||_animators.property(_i).name.indexOf("FishTools - ")===0){',
            ...
            '',
            '    app.beginUndoGroup("DenjiMotion - ' + p.label + '");',
            '',
            ...
            '    _anim.name="DenjiMotion - ' + p.label + '";',
            '',
    ...
    function _clearAnimation() {
        ...
        var script = [
            ...
            '      return JSON.stringify({error:true, message:"Selected layer is not a text layer."});',
            '',
            '    app.beginUndoGroup("DenjiMotion - Clear Text Animation");',
            '',
            '    var animators = layer.property("ADBE Text Properties").property("ADBE Text Animators");',
            '    if(animators) {',
            '      for(var i = animators.numProperties; i >= 1; i--) {',
            '        var anim = animators.property(i);',
            '        if(anim && anim.name && (anim.name.indexOf("DenjiMotion - ") === 0 || anim.name.indexOf("FishTools - ") === 0)) {',
            '          anim.remove();',
            '        }',
            '      }',
            '    }',
